...
document.querySelector('#app').innerHTML = `
  <div>
    ...
    <div >
      <iframe width="560" height="315" src="https://www.youtube.com/embed/JRAOdRq-1lw?si=whw5ivlUg3iThhyt&amp;start=6" class="zombie-video" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
    <hr>
    <h2>Video intelligence report:<h2>
    <!-- Luke Skywalker -->
    <div>
      <h2 class="top-secret">Pilot: Luke Skywalker</h2>
      <p class="normal-text">
      ...
      <p id="Luke" class="normal-text"></p>
    </div>
    <!-- At At Walker -->
    <div>
      <h2 class="top-secret">Walker: At At Walker</h2>
      <p class="normal-text">
      ...
      <p id="Walker" class="normal-text"></p>
    </div>
  </div>
`
